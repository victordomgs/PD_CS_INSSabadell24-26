...
- [5.1.1 Resuma las diferencias entre datos e información](#511-resuma-las-diferencias-entre-datos-e-información)
- [5.1.2 Resuma las diferencias entre un sistema de información y una base de datos](#512-resuma-las-diferencias-entre-un-sistema-de-información-y-una-base-de-datos)
- [5.1.3 Discuta por qué son necesarias las bases de datos](#513-discuta-por-qué-son-necesarias-las-bases-de-datos)
- [5.1.4 Describa el uso de transacciones, estados y actualizaciones para mantener la coherencia de los datos (y la integridad)](#514-describa-el-uso-de-transacciones-estados-y-actualizaciones-para-mantener-la-coherencia-de-los-datos-y-la-integridad)
- [5.1.5 Defina el término "transacción de bases de datos"](#515-defina-el-término-transacción-de-bases-de-datos)
- [5.1.6 Explique la concurrencia en una situación en que se compartan datos](#516-explique-la-concurrencia-en-una-situación-en-que-se-compartan-datos)
- [5.1.7 Explique la importancia de las propiedades ACID en una transacción de bases de datos](#517-explique-la-importancia-de-las-propiedades-acid-en-una-transacción-de-bases-de-datos)
- [5.1.8 Describa las dos funciones que se deben realizar sobre las bases de datos](#518-describa-las-dos-funciones-que-se-deben-realizar-sobre-las-bases-de-datos)
- [5.1.9 Explique la función de la validación de datos y la verificación de datos](#519-explique-la-función-de-la-validación-de-datos-y-la-verificación-de-datos)

---

## 5.1.1 Resuma las diferencias entre datos e información
...
## 5.1.2 Resuma las diferencias entre un sistema de información y una base de datos
...
## 5.1.3 Discuta por qué son necesarias las bases de datos
...
## 5.1.4 Describa el uso de transacciones, estados y actualizaciones para mantener la coherencia de los datos (y la integridad)
...
## 5.1.5 Defina el término "transacción de bases de datos"
...
## 5.1.6 Explique la concurrencia en una situación en que se compartan datos
...
## 5.1.7 Explique la importancia de las propiedades ACID en una transacción de bases de datos
...
## 5.1.8 Describa las dos funciones que se deben realizar sobre las bases de datos
...
## 5.1.9 Explique la función de la validación de datos y la verificación de datos
