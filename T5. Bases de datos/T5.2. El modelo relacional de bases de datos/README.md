...
- [5.2.1 Defina los términos "SGBD" y "SGBDR"](#521-defina-los-términos-sgbd-y-sgbdr)
- [5.2.2 Resuma las funciones y herramientas de un SGBD](#522-resuma-las-funciones-y-herramientas-de-un-sgbd)
- [5.2.3 Describa cómo se puede usar un SGBD para potenciar la seguridad de los datos](#523-describa-cómo-se-puede-usar-un-sgbd-para-potenciar-la-seguridad-de-los-datos)
- [5.2.4 Defina el término "esquema"](#524-defina-el-término-esquema)
- [5.2.5 Identifique las características de los tres niveles del esquema: conceptual, lógico y físico](#525-identifique-las-características-de-los-tres-niveles-del-esquema-conceptual-lógico-y-físico)
- [5.2.6 Resuma la naturaleza del diccionario de datos](#526-resuma-la-naturaleza-del-diccionario-de-datos)
- [5.2.7 Explique la importancia del lenguaje de definición de datos en la implementación de un modelo de datos](#527-explique-la-importancia-del-lenguaje-de-definición-de-datos-en-la-implementación-of-un-modelo-de-datos)
- [5.2.8 Explique la importancia de los modelos de datos en el diseño de una base de datos](#528-explique-la-importancia-de-los-modelos-de-datos-en-el-diseño-de-una-base-de-datos)
- [5.2.9 Defina los términos relacionados con las bases de datos: tabla, registro, campo, etc](#529-defina-los-siguientes-términos-relacionados-con-las-bases-de-datos-tabla-registro-campo-clave-principal-clave-secundaria-clave-externa-clave-candidata-clave-primaria-compuesta-y-composición)
- [5.2.10 Identifique los distintos tipos de relaciones en una base de datos: una a una, una a muchas y muchas a muchas](#5210-identifique-los-distintos-tipos-de-relaciones-en-una-base-de-datos-una-a-una-una-a-muchas-y-muchas-a-muchas)
- [5.2.11 Resuma los problemas generados por los datos redundantes](#5211-resuma-los-problemas-generados-por-los-datos-redundantes)
- [5.2.12 Resuma la importancia de la integridad referencial en una base de datos normalizada](#5212-resuma-la-importancia-de-la-integridad-referencial-en-una-base-de-datos-normalizada)
- [5.2.13 Describa las diferencias entre la primera forma normal (1FN), la segunda forma normal (2FN) y la tercera forma normal (3FN)](#5213-describa-las-diferencias-entre-la-primera-forma-normal-1fn-la-segunda-forma-normal-2fn-y-la-tercera-forma-normal-3fn)
- [5.2.14 Describa las características de una base de datos normalizada](#5214-describa-las-características-de-una-base-de-datos-normalizada)
- [5.2.15 Evalúe la idoneidad de los distintos tipos de datos](#5215-evalúe-la-idoneidad-de-los-distintos-tipos-de-datos)

---

## 5.2.1 Defina los términos "SGBD" y "SGBDR"
...
## 5.2.2 Resuma las funciones y herramientas de un SGBD
...
## 5.2.3 Describa cómo se puede usar un SGBD para potenciar la seguridad de los datos
...
## 5.2.4 Defina el término "esquema"
...
## 5.2.5 Identifique las características de los tres niveles del esquema: conceptual, lógico y físico
...
## 5.2.6 Resuma la naturaleza del diccionario de datos
...
## 5.2.7 Explique la importancia del lenguaje de definición de datos en la implementación de un modelo de datos
...
## 5.2.8 Explique la importancia de los modelos de datos en el diseño de una base de datos
...
## 5.2.9 Defina los términos relacionados con las bases de datos: tabla, registro, campo, etc
...
## 5.2.10 Identifique los distintos tipos de relaciones en una base de datos: una a una, una a muchas y muchas a muchas
...
## 5.2.11 Resuma los problemas generados por los datos redundantes
...
## 5.2.12 Resuma la importancia de la integridad referencial en una base de datos normalizada
...
## 5.2.13 Describa las diferencias entre la primera forma normal (1FN), la segunda forma normal (2FN) y la tercera forma normal (3FN)
...
## 5.2.14 Describa las características de una base de datos normalizada
...
## 5.2.15 Evalúe la idoneidad de los distintos tipos de datos
