...
[6. Gestión del cambio](#6-gestión-del-cambio)  
  - [6.1. Un modelo de gestión del cambio](#61-un-modelo-de-gestión-del-cambio)
  - [6.2. Análisis de implicados](#62-análisis-de-implicados)
  - [6.3. Causas de las resistencias al cambio](#63-causas-de-las-resistencias-al-cambio)
  - [6.4. Buenas prácticas de intervención sobre la comunicación](#64-buenas-prácticas-de-invervención-sobre-la-comunicación)
  - [6.5. El plan de formación](#65-el-plan-de-formación)

[7. Gestión del proyecto](#7-gestión-del-proyecto)  
  - [7.1. Procesos típicos de la gestión de proyectos](#71-procesos-típicos-de-la-gestión-de-proyectos)
  - [7.2. Las áreas de conocimiento](#72-las-áreas-de-conocimiento)
  - [7.3. La organización del proyecto](#73-la-organización-del-proyecto)
      - [7.3.1. Roles clave en el proyecto](#731-roles-clave-en-el-proyecto)

[8. Importancia de las pruebas](#8-los-sistemas-de-información)  
  - [8.1. Beneficios de las pruebas](#81-beneficios-de-las-pruebas)
  - [8.2. Pruebas en todas las fases del ciclo de vida](#82-pruebas-en-todas-las-fases-del-ciclo-de-vida)
  - [8.3. Distintos tipos de pruebas de Software](#83-distintos-tipos-de-pruebas-de-software)

[9. Documentación técnica y de usuario](#1-introducción)  
  - [9.1. Definición y propósito](#91-definición-y-propósito)
  - [9.2. Diferencias entre documentación técnica y de usuario](#92-diferencias-entre-documentación-técnica-y-de-usuario)
  - [9.3. Importancia de la documentación del usuario](#93-importancia-de-la-documentación-del-usuario)  
      - [9.3.1. Rol en la implementación del sistema](#931-rol-en-la-implementación-del-sistema)
      - [9.3.2. Relación entre calidad de la documentación y éxito del sistema](#932-relación-entre-calidad-de-la-documentación-y-éxito-del-sistema)
  - [9.4. Métodos para ofrecer documentación al usuario](#94-métodos-para-ofrecer-documentación-al-usuario)  
      - [9.4.1. Métodos tradicionales](#941-métodos-tradicionales)
      - [9.4.2. Métodos digitales](#942-métodos-digitales)
      - [9.4.3. Métodos interactivos](#943-métodos-interactivos)

[10. Gestión de versiones y actualizaciones](#1-introducción) 
...
- [10.4. Métodos para evitar la pérdida de datos](#104-métodos-para-evitar-la-pérdida-de-datos) 
    ...
    - [10.4.3. Uso de medios extraíbles](#1043-uso-de-medios-extraíbles)
    - [10.4.4. Almacenamiento externo y en línea](#1044-almacenamiento-externo-y-en-línea)
- [10.5. Implementación de sistemas de control de versiones (SCV)](#105-implementación-de-sistemas-de-control-de-versiones-(SCV)) 
    - [10.5.1. Beneficios de un SCV en la ingeniería de software](#1051-beneficios-de-un-SCV-en-la-ingeniería-de-software)
    - [10.5.2. Herramientas populares](#1052-herramientas-populares)
...
### 6.1. Un modelo de gestión del cambio
...
### 6.3. Causas de las resistencias al cambio
...
### 6.4. Buenas prácticas de intervención sobre la comunicación
...
### 7.1. Procesos típicos de la gestión de proyectos
...
### 7.2. Las áreas de conocimiento

La gestión de proyectos se basa en una serie de áreas de conocimiento que abarcan los procesos y actividades clave necesarios para planificar, ejecutar y controlar un proyecto con éxito. Estas áreas no solo estructuran el trabajo del director de proyectos, sino que también permiten coordinar los recursos, mitigar riesgos y alcanzar los objetivos dentro de los plazos y presupuestos establecidos.

Cada área de conocimiento aborda un aspecto específico del proyecto, desde la integración y el alcance hasta la comunicación y la gestión de riesgos. Entenderlas y aplicarlas de manera efectiva es esencial para garantizar resultados de calidad, satisfacer a las partes interesadas y maximizar la rentabilidad de los proyectos, especialmente en entornos tecnológicos donde los desafíos suelen ser complejos y multidimensionales.

1. **Gestión de la Integración:** Coordina y unifica las actividades del proyecto, incluyendo toma de decisiones, asignación de recursos y representación ante terceros.
2. **Gestión del Alcance:** Define lo que el proyecto debe y no debe incluir, previniendo desviaciones de alcance que puedan afectar tiempo y costos.
3. **Gestión del Tiempo:** Garantiza que las tareas y hitos se completen dentro del cronograma establecido, considerando tanto eficiencia interna como cumplimiento contractual.
4. **Gestión de los Costos:** Abarca la estimación, control y proyección del presupuesto del proyecto, evaluando el rendimiento económico.
5. **Gestión de la Calidad:** Asegura conformidad con estándares y satisfacción del cliente, incorporando procesos de mejora continua.
6. **Gestión de Recursos Humanos:** Incluye la organización, asignación de responsabilidades y desarrollo del equipo humano asignado al proyecto.
7. **Gestión de la Comunicación:** Facilita la generación y distribución efectiva de la información del proyecto, asegurando la alineación con las expectativas de las partes interesadas.
8. **Gestión de los Riesgos:** Identifica, analiza y responde a eventos potenciales que puedan impactar el proyecto, estableciendo medidas preventivas y correctivas.
9. **Administración de Compras y Contratos:** Gestiona las relaciones con clientes y subcontratistas, incluyendo aspectos económicos y legales críticos.
...
#### 7.3.1. Roles clave en el proyecto
...
### 8.2. Pruebas en todas las fases del ciclo de vida
...
### 8.3. Distintos tipos de pruebas de Software
...
## 10. Gestión de versiones y actualizaciones

### 10.1. ¿Qué es la gestión de versiones?
...
### 10.2. Importancia de las actualizaciones
...
## 10.3. Pérdida de datos y sus consecuencias

### 10.3.1. Impacto de la pérdida de datos
...
## 10.4. Métodos para evitar la pérdida de datos

### 10.4.1. Sistemas de conmutación por error
...
### 10.4.3. Uso de medios extraíbles
...
### 10.4.4. Almacenamiento externo y en línea
...
## 10.5. Implementación de sistemas de control de versiones (SCV)

### 10.5.1. Beneficios de un SCV en la ingeniería de software
