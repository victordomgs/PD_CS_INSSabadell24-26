...
### Concentradores (Hubs)
Un hub es el punto de conexión para los dispositivos en una sola red. Los dispositivos de red y los sistemas informáticos se conectan a un hub utilizando cables Ethernet que se conectan a un puerto. Un hub consta de múltiples puertos.
