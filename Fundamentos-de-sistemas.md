...
- [3. Sistemas de información en las organizaciones](#3-sistemas-de-información-en-las-organizaciones)
  - [3.1. Relación de los sistemas de información con el entorno organizacional](#31-relación-de-los-sistemas-de-información-con-el-entorno-organizacional)
    - [3.1.1. La función de los sistemas de información en la comunicación interna y externa](#311-la-función-de-los-sistemas-de-información-en-la-comunicación-interna-y-externa)
    - [3.1.2. Adaptación a los cambios en el entorno](#312-adaptación-a-los-cambios-en-el-entorno)
    - [3.1.3. El sistema de información como soporte para la adaptación organizacional](#313-el-sistema-de-información-como-soporte-para-la-adaptación-organizacional)
  - [3.2. Sistema de información, sistema de decisión y sistema de producción](#32-sistema-de-información-sistema-de-decisión-y-sistema-de-producción)
    - [3.2.1. Relación entre el sistema de información y el sistema de decisión](#321-relación-entre-el-sistema-de-información-y-el-sistema-de-decisión)
      - [3.2.1.1. Provisión de datos y análisis para la toma de decisiones](#3211-provisión-de-datos-y-análisis-para-la-toma-de-decisiones)
      - [3.2.1.2. Apoyo en la planificación estratégica y operativa](#3212-apoyo-en-la-planificación-estratégica-y-operativa)
    - [3.2.2. Relación entre el sistema de información y el sistema de producción](#322-relación-entre-el-sistema-de-información-y-el-sistema-de-producción)
      - [3.2.2.1. Optimización de los procesos productivos](#3221-optimización-de-los-procesos-productivos)
      - [3.2.2.2. Integración de la información de producción con la gestión de inventarios y recursos](#3222-integración-de-la-información-de-producción-con-la-gestión-de-inventarios-y-recursos)
  - [3.3. Sistemas de planificación de recursos empresariales (ERP) y software como servicio (SaaS)](#33-sistemas-de-planificación-de-recursos-empresariales-erp-y-software-como-servicio-saas)
    - [3.3.1. Enterprise Resource Planning (ERP)](#331-enterprise-resource-planning-erp)
    - [3.3.2. Software como servicio (SaaS)](#333-software-como-servicio-saas)
    - [3.3.3. Comparación entre soluciones ERP locales y ERP basados en SaaS](#334-comparación-entre-soluciones-erp-locales-y-erp-basados-en-saas)
  - [3.4. Implementación de un sistema de información](#34-implementación-de-un-sistema-de-información)
    - [3.4.1. Estrategias para una implementación exitosa de sistemas de información](#342-estrategias-para-una-implementación-exitosa-de-sistemas-de-información)
    - [3.4.1. Resistencia al cambio en las organizaciones](#341-resistencia-al-cambio-en-las-organizaciones)
    - [3.4.3. La importancia de la formación y la comunicación](#343-la-importancia-de-la-formación-y-la-comunicación)
...
en marcha con garantías de funcionamiento. Todas estas tareas implican necesariamente combinar recursos humanos, materiales, económicos, etc.
  ...
  <div style="text-align: center;">
  <img src="https://github.com/victordomgs/Teoria-de-sistemas-i-computacion/blob/main/images/Figura%2014.%20Fundamentos%20de%20sistemas.png" alt="Descripción de la imagen" width="930" height="503"/>
