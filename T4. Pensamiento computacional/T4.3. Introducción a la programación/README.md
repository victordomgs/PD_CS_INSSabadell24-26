...
- [4.3.1 Indique las operaciones fundamentales de un computador](#431-indique-las-operaciones-fundamentales-de-un-computador)
- [4.3.2 Distinga entre operaciones fundamentales y operaciones compuestas de un computador](#432-distinga-entre-operaciones-fundamentales-y-operaciones-compuestas-de-un-computador)
- [4.3.3 Explique las características esenciales de un lenguaje informático](#433-explique-las-características-esenciales-de-un-lenguaje-informático)
- [4.3.4 Explique la necesidad de los lenguajes de alto nivel](#434-explique-la-necesidad-de-los-lenguajes-de-alto-nivel)
- [4.3.5 Resuma la necesidad de un proceso de traducción desde un lenguaje de alto nivel a código máquina ejecutable](#435-resuma-la-necesidad-de-un-proceso-de-traducción-desde-un-lenguaje-de-alto-nivel-a-código-máquina-ejecutable)
- [4.3.6 Defina los términos "variable", "constante", "operador" y "objeto"](#436-defina-los-términos-variable-constante-operador-y-objeto)
- [4.3.7 Defina los operadores =, ≠, <, <=, >, >=, mod, div](#437-defina-los-operadores--<--=-mod-div)
- [4.3.8 Analice el uso de variables, constantes y operadores en los algoritmos](#438-analice-el-uso-de-variables-constantes-y-operadores-en-los-algoritmos)
- [4.3.9 Elabore algoritmos usando bucles y bifurcaciones](#439-elabore-algoritmos-usando-bucles-y-bifurcaciones)
- [4.3.10 Describa las características y las aplicaciones de una colección](#4310-describa-las-características-y-las-aplicaciones-de-una-colección)
- [4.3.11 Elabore algoritmos usando los métodos de acceso de una colección](#4311-elabore-algoritmos-usando-los-métodos-de-acceso-de-una-colección)
- [4.3.12 Discuta la necesidad de subprogramas y colecciones dentro de las soluciones programadas](#4312-discuta-la-necesidad-de-subprogramas-y-colecciones-dentro-de-las-soluciones-programadas)
- [4.3.13 Elabore algoritmos usando subprogramas predefinidos, matrices unidimensionales y/o colecciones](#4313-elabore-algoritmos-usando-subprogramas-predefinidos-matrices-unidimensionales-yo-colecciones)

---

## 4.3.1 Indique las operaciones fundamentales de un computador
...
## 4.3.2 Distinga entre operaciones fundamentales y operaciones compuestas de un computador
...
## 4.3.3 Explique las características esenciales de un lenguaje informático
...
## 4.3.4 Explique la necesidad de los lenguajes de alto nivel
...
## 4.3.5 Resuma la necesidad de un proceso de traducción desde un lenguaje de alto nivel a código máquina ejecutable
...
## 4.3.6 Defina los términos "variable", "constante", "operador" y "objeto"
...
## 4.3.7 Defina los operadores =, ≠, <, <=, >, >=, mod, div
...
## 4.3.8 Analice el uso de variables, constantes y operadores en los algoritmos
...
## 4.3.9 Elabore algoritmos usando bucles y bifurcaciones

WIP

<br>

## 4.3.10 Describa las características y las aplicaciones de una colección
...
## 4.3.11 Elabore algoritmos usando los métodos de acceso de una colección

WIP

<br>

## 4.3.12 Discuta la necesidad de subprogramas y colecciones dentro de las soluciones programadas
...
## 4.3.13 Elabore algoritmos usando subprogramas predefinidos, matrices unidimensionales y/o colecciones
