...
- [3.2.4. Explique por qué es necesaria la compresión de datos cuando se transmiten](#324-explique-por-qué-es-necesaria-la-compresión-de-datos-cuando-se-transmiten)
...
## 3.2.4. Explique por qué es necesaria la compresión de datos cuando se transmiten
